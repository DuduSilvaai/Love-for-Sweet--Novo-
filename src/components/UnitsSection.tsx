  ...
  const stores = [
    {
      ...
      image: barueri,
      mapsLink:
        "https://www.google.com/maps/place/Love+For+Sweet/@-23.4824921,-47.414618,10z/data=!4m6!3m5!1s0x94cf036876cecbff:0x1b76f0a36872987f!8m2!3d-23.5091465!4d-46.8875661!16s%2Fg%2F11lh6ft4_n?entry=ttu&g_ep=EgoyMDI1MTAwOC4wIKXMDSoASAFQAw%3D%3D",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      image: sorocaba,
      mapsLink:
        "https://www.google.com/maps/place/Love+For+Sweet+-+Sorocaba/@-23.5360247,-47.4644396,17z/data=!3m1!4b1!4m6!3m5!1s0x94c58b2597399971:0xb7ed877cf0a4e6dc!8m2!3d-23.5360247!4d-47.4644396!16s%2Fg%2F11xmkr8k68?entry=ttu&g_ep=EgoyMDI1MTAwOC4wIKXMDSoASAFQAw%3D%3D",
    },
    {
      id: 7,
      ...
      image: botucatu,
      mapsLink:
        "https://www.google.com/maps/place/Shopping+Park+Botucatu/@-22.9144088,-48.4661254,17z/data=!3m1!4b1!4m6!3m5!1s0x94c6df23759d49bf:0xa61da4e8682a0cf4!8m2!3d-22.9144088!4d-48.4635505!16s%2Fg%2F1q67q_yjd?entry=ttu&g_ep=EgoyMDI1MTAwOC4wIKXMDSoASAFQAw%3D%3D",
    },
  ];
  return (
          ...
          >
            <Card className="p-8 bg-gradient-primary text-white shadow-primary border-0 max-w-2xl mx-auto">
              ...
              <p className="opacity-90 font-light text-base">
                Experimente pessoalmente os doces da LOVE e descubra por que
                somos a escolha preferida para momentos especiais.
              </p>
            </Card>
          </div>
